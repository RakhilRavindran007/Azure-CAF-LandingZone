...
locals {
  ...
  subscription_id_management       = coalesce(var.subscription_id_management, data.azurerm_client_config.core.subscription_id)
  subscription_id_connectivity     = coalesce(var.subscription_id_connectivity, data.azurerm_client_config.core.subscription_id)
  #subscription_id_identity         = coalesce(var.subscription_id_connectivity, local.subscription_id_management)
}
