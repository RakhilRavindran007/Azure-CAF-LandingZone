...
resource "azurerm_subnet" "connectivity" {
  ...
  # Optional resource attributes
  private_endpoint_network_policies_enabled      = each.value.template.enforce_private_link_endpoint_network_policies
  private_link_service_network_policies_enabled  = each.value.template.enforce_private_link_service_network_policies
